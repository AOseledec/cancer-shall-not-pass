<template>
  <div class="politics">
    ...
    <ol>
      <li class="politics__general politics__general_text-punkt">
    ...
    <ol>
      <li class="politics__terms politics__terms_punkt">
    ...
    <ol>
      <li class="politics__rights politics__rights_punkt">
        Фамилия, имя, отчество;
      </li>
      <li class="politics__rights politics__rights_punkt">
        Электронный адрес;
      </li>
      <li class="politics__rights politics__rights_punkt">Номера телефонов;</li>
      <li class="politics__rights politics__rights_punkt">
        Год, месяц, дата и место рождения;
      </li>
      <li class="politics__rights politics__rights_punkt">Фотографии;</li>
      <li class="politics__rights politics__rights_punkt">
    ...
    <ol>
      <li class="politics__footing politics__footing_punkt">
    ...
    <p class="polotics__order politics__order_text">
    ...
    <ol>
      <li class="politics__order politics__order_punkt">
    ...
    <ol>
      <li class="politics__data politics__data_punkt">
